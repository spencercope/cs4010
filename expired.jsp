...
<html>
    ...
    <body>
        ...
        <div class="container">
           <center>
              <h1 class="jumbotron">
                 Timeout! &nbsp; <i class="fa fa-clock-o fa-6" aria-hidden="true"></i>
              </h1>
               <div class="well" style="width: 50%;">
                   <h3 style="padding-bottom: 20px;">Well, this is awkward, your session has timed out.  Try to be more careful next time.</h3>
